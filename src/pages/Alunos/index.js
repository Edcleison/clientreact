        ...
        <div className="aluno-container">
            <header>
                ...
                <button onClick={logout} type="button">
                    <FiXCircle siza={35} color="#17202a" />
                </button>
            </header>
            <form>
                ...
                {filtro.map(aluno => (
                    <li key={aluno.id}>
                        ...
                        <button onClick={() => editAluno(aluno.id)} type="button">
                            <FiEdit size="25" color="#17202e" />
                        </button>
                        <button type="button" onClick={() => deleteAluno(aluno.id)}>                            <FiUserX size="25" color="#17202e" />
                        </button>
                    </li>
                ))}
                </ul>
